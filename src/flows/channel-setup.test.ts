...
describe("setupChannels workspace shadow exclusion", () => {
  ...
  it("keeps successful no-op setup results selected", async () => {
    ...
    expect(onSelection).toHaveBeenCalledWith(["signal"]);
    expect(onAccountId).toHaveBeenCalledWith("signal", "default");
  });
